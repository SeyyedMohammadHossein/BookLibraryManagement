...
@WebServlet(name = "delete_user_servlet", value = "/delete_user_servlet")
public class DeleteUserServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (id.isEmpty()){
            out.println("<html><head><title>delete user result</title><link rel=\"stylesheet\" href=\"style.css\"></head><body class=\"container\">");
        ...
        out.println("<html><head><title>delete user result</title><link rel=\"stylesheet\" href=\"style.css\"></head><body class=\"container\">");
        out.println("<div class=\"center\"><b class=\"res\">" + library.deleteUser(Integer.parseInt(id)) + "</b><br><br>");
